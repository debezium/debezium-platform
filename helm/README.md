...
|:-------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|
| domain.hostname                            | hostname used as ingress host                                                                                                                                                          | ""                                         |
| domain.scheme                              | scheme used when building URLs from `domain.hostname`                                                                                                                                  | https                                      |
| domain.url                                 | domain used as ingress host (DEPRECATED, URLs are hardcoded to http when this is used. Use `domain.hostname` and `domain.scheme` instead.)                                             | ""                                         |
...
| ingress.tls.secretName                     | Secret name used when TLS is enabled                                                                                                                                                   | conductor-ingress-tls                      |
